 ...
 */
@ThreadSafe
public class LMDefaultHttpClient extends AbstractHttpClient {
    ...
    /**
     * Creates the default set of HttpParams by invoking {@link LMDefaultHttpClient#setDefaultHttpParams(HttpParams)}
     *
    ...
    public static void setDefaultHttpParams(HttpParams params) {
        ...
        final VersionInfo vi = VersionInfo.loadVersionInfo
                ("org.apache.http.client", LMDefaultHttpClient.class.getClassLoader());
