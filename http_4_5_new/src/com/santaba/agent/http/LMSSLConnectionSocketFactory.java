 ...
 * Date: 7/14/15
 */
public class LMSSLConnectionSocketFactory implements LayeredConnectionSocketFactory {
     ...
     */
    public static LMSSLConnectionSocketFactory getSocketFactory() throws SSLInitializationException {
        return new LMSSLConnectionSocketFactory(SSLContexts.createDefault(), getDefaultHostnameVerifier());
    }
     ...
     */
    public static LMSSLConnectionSocketFactory getSystemSocketFactory() throws SSLInitializationException {
        return new LMSSLConnectionSocketFactory(
    ...
    public LMSSLConnectionSocketFactory(final SSLContext sslContext) {
        this(sslContext, getDefaultHostnameVerifier());
    }

    /**
     * @deprecated (4.4) Use {@link #LMSSLConnectionSocketFactory(javax.net.ssl.SSLContext,
     *   javax.net.ssl.HostnameVerifier)}
     */
    @Deprecated
    public LMSSLConnectionSocketFactory(
    ...
    /**
     * @deprecated (4.4) Use {@link #LMSSLConnectionSocketFactory(javax.net.ssl.SSLSocketFactory,
     *   javax.net.ssl.HostnameVerifier)}
     */
    @Deprecated
    public LMSSLConnectionSocketFactory(
